...
<div className="relative flex max-h-[400px] max-w-full justify-center">
  <Image
    alt="CLS score bar"
    src="/static/images/tech/cls-score-bar.webp"
    width={0}
    height={0}
    sizes="100vw"
...
<div className="relative max-h-[400px] max-w-full flex justify-center">
  <Image 
    alt="Victor Mono measurements" 
    src="/static/images/tech/Victo-Mono-measurements.png"
    width={0}
    height={0}
    sizes="100vw"
...
<div className="relative max-h-[400px] max-w-full flex justify-center">
  <Image
    alt="better fallback font"
    src="/static/images/tech/better-fallback-font.png"
    width={0}
    height={0}
    sizes="100vw"
    className="my-0 w-auto h-auto max-h-[400px] max-w-full"
