...
- <font style="color:rgb(163, 21, 21);">design:type 属性的类型</font>
- <font style="color:rgb(163, 21, 21);">design:paramtypes 函数参数的类型列表, 可以用这个</font>
- <font style="color:rgb(163, 21, 21);">design:returetype 函数的返回类型</font>
