...
tags:
  ...
  - 前端性能优化
  - 新技术趋势
summary: 由于Cursor限制，中国大陆IP无法使用大模型，作者分享了两种绕过方法，但在WSL中遇到问题。
draft: false
images: []
---
...
<div className="flex justify-center">
  <Image
    alt="Pasted image 20250725150722.png"
...
<div className="flex justify-center">
  <Image
    alt="Pasted image 20250725150916.png"
...
<div className="flex justify-center">
  <Image
    alt="Pasted image 20250725164905.png"
...
<div className="flex justify-center">
  <Image
    alt="Pasted image 20250725165048.png"
...
本以为这样子就万事大吉了，但是我发现虽然 chat 没问题。了，但是 index 不行了。首先无法加载到之前 index 的信息，然后一直卡在 setup indexing...

再之后，我的 Trae 也无法打开 WSL 开发了，初始化都失败了。🥲

<div className="flex justify-center">
  <Image
    alt="Pasted image 20250725164540.png"
    src="/static/images/blog/Pasted image 20250725164540.png"
    width={0}
    height={0}
    sizes="100vw"
    className="my-0 h-auto max-h-[400px] w-auto max-w-full"
...
总结： 这种方式只适用于 macos, linux, 或者只在 windows 里面开发， 不适用于 WSL。WSL 设置 mirrored network + tun 模式，有很多网络问题，我暂时无法解决。
...
<div className="flex justify-center">
  <Image
    alt="Pasted image 20250725172859.png"
